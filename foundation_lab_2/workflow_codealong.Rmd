...
```{r}
#load with here package: where I am currently working for my project
...
#"subject" "semester" "section" are new variable names
#time_spent_2 was used to create a new name of the data frame
